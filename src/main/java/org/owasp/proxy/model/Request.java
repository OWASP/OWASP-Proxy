...
public class Request extends Message {
	 ...
	 *            the InputStream
	 * @param out
	 *            an OutputStream to write the entity to
	 * @return true if any bytes were read from the stream
	 * 
	 * @throws IOException
	 * @throws MessageFormatException
	 *             if the request headers could not be parsed
	 */
	public static boolean flushContent(Request request, InputStream in,
			OutputStream out) throws IOException, MessageFormatException {
