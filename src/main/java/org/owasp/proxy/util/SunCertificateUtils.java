...
public class SunCertificateUtils {
	...
	public static X509Certificate sign(X500Principal subject, PublicKey pubKey, X500Principal issuer, PublicKey caPubKey,
		 ...
		 * provider instead of BouncyCastle. If we don't do this trick we might run
		 * into trouble when trying to use the CertPath validator.
		 */
